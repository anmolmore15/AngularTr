...
class Car implements Drivable {
    ...
    /**
    *   Attempt to drive a distance. Returns true or false based on whether or not 
...
// Want to experiment? Try adding a second interface: Flyable. Implement it in a Helicopter class,
// then write a FlyingCar class that implements both Drivable and Flyable!